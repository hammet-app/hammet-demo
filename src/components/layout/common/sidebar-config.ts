...
export const navConfig: Record<UserRole, NavEntry[]> = {
  student: [
    ...
    {type: "item", label: "Help", action: "help", icon: CircleHelp,},
  ],
  ...
  hammet_admin: [
    ...
    { type: "item", label: "Upload Modules",     href: "/hammet/modules/bulk",icon: Upload,  },
    {type: "item", label: "AI Disputes", href: "/hammet/disputes", icon: ClipboardList,},
    {type: "item", label: "Help", action: "help", icon: CircleHelp,},
  ],
};
